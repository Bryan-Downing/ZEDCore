...
namespace ZED.Interfaces
{
    public interface IDisplay : IDisposable
    {
        ...
        /// <param name="color"></param>
        void DrawRect(int x, int y, int width, int height, SKColor color);
        ...
        /// <param name="height"></param>
        /// <param name="color"></param>
        void DrawBox(int x, int y, int width, int height, SKColor color);
        ...
        void DrawText(object font, int x, int y, SKColor color, string text, int spacing = 0, bool vertical = false);
        ...
        void DrawImage(int x, int y, SKBitmap image);
        ...
        void DrawCircle(int x, int y, int r, SKColor color, bool filled = false);
        ...
        /// <param name="y2"></param>
        /// <param name="color"></param>
        void DrawLine(int x1, int y1, int x2, int y2, SKColor color);
