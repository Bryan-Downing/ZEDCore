...
namespace ZED.Scenes
{
    public class Intro : Scene
    {
        ...
        {
            _pixelColors = new SKColor[Display.Width, Display.Height];
        ...
        protected override void PrimaryExecutionMethod()
        {
            ...
            for (int x = 0; x < Display.Width; x++)
            {
                ...
                {
                    if (_pixelColors[x, y].Red != 0 ||
                        _pixelColors[x, y].Green != 0 ||
                        _pixelColors[x, y].Blue != 0)
                    {
            ...
            for (int x = 0; x < Display.Width; x++)
            {
                for (int y = 0; y < Display.Height; y++)
                {
                    if (_pixelColors[x, y].Red == 0 &&
                        ...
                        _pixelColors[x, y].Blue == 0)
                    {
                        Display.SetPixel(x, y, SKColors.Black);
                    }
                }
            }
