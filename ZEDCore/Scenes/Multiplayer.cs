...
namespace ZED.Scenes
{
    ...
    {
        private SKBitmap _heartBitmap;
        private SKBitmap _skullBitmap;
        ...
        protected override void Setup()
        {
            ...
            _score = 0;
            _scoreText = new GUI.Text(0, 8, $"{_score}", SKColors.White, Common.Fonts.FiveBySeven);
            _gameOverText = new GUI.Text(0, Display.Height / 2, "YOU DIED", SKColors.White, Common.Fonts.NineByFifteen);
            ...
            _skullBitmap = null; // Properties.Resources.Skull.ToSKBitmap(); TODO
            _heartBitmap = null; // Properties.Resources.Heart.ToSKBitmap(); TODO
        }
        ...
        protected override void PrimaryExecutionMethod()
        {
            ...
            foreach (var player in _playerDict.Select(x => x.Value))
            {
                player.Update(LastFrameMS, Display);
                player.Draw(Display);
        ...
        private void InitStar(Star star)
        {
            ...
            star.Hue = (_starField.Stars.FirstOrDefault()?.Hue ?? 0) + _currentLevel + (ZEDProgram.Instance.Random.Next() % 30);
        ...
        private class Player
        {
            ...
            public SKColor PlayerColor = SKColors.White;
